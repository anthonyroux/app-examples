...
│      useTranslator.ts <-- Functions to translate content
...
This sample app shows how you can translate content from the board in various languages. It allows as well to create content after live translating it. This example will cover how to use a 3rd party API in a Miro application, how to retreive selected content on a board and create/update content. \
